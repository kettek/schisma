...
test('$type Null',    t => t.deepEqual(null, schisma({$type: null}).create()))
...
test('$type Array of Nulls',    t => t.deepEqual([null], schisma({$type: [null]}).create({populateArrays: true})))
...
test('$type Object of Null',    t => t.deepEqual({a: null}, schisma({$type: {a: null}}).create()))
...
test('$typeof Null',    t => t.deepEqual(null, schisma({$typeof: [null]}).create()))
...
test('$typeof Array of Null',    t => t.deepEqual([null], schisma({$typeof: [[null]]}).create({populateArrays: true})))
...
test('$typeof String||Null',    t => t.deepEqual('', schisma({$typeof: [String,null]}).create()))
...
test('$typeof Null||String',    t => t.deepEqual(null, schisma({$typeof: [null,String]}).create()))
